...
public class YourlogoRegistration {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.id("email_create")).sendKeys("august4monday@yopmail.com");
		...
		driver.findElement(By.id("customer_lastname")).sendKeys("months");
		...
		driver.findElement(By.id("lastname")).sendKeys("month");
